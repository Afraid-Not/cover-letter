      ...
      <section className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-6">
            ...
            {onGoogleSignIn && (
              <>
                <div className="signin-element signin-delay-700 relative flex items-center justify-center">
                ...
                <button
                  ...
                  className="signin-element signin-delay-800 w-full flex items-center justify-center gap-3 border border-border rounded-2xl py-4 hover:bg-secondary transition-colors"
                >
                  <GoogleIcon />
                  Google로 계속하기
                </button>
